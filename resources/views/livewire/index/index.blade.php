<main class="main container-fluid">
    ...
    <div class=" row top_header_banner align-items-center justify-content-center">
        <div
            class="bg_blur_light p-4 bg_blur_light rounded_5 d-none d-md-block animate__animated animate__fadeInDown
            animate__delay-1s ">
        ...
        <div class="row col-12 col-md-10 justify-content-center article_goup">
            @foreach ($categories as $cat)
                <a href="{{route('index-search',$cat->id)}}"
                   class="p-4 col-11 col-md-4 animate__animated animate__fadeInDown">
